...
import net.metalsight.hrigtools.item.custom.MetalDetectorItem;
import net.metalsight.hrigtools.item.custom.ModToolTiers;
...
public class ModItems {
    public static  final DeferredRegister<Item> ITEMS =
            DeferredRegister.create(ForgeRegistries.ITEMS, Hrigtools.MOD_ID);
